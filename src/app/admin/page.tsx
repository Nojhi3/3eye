...
export default function AdminDashboard() {
  ...
  const [usersDb, setUsersDb] = useState<User[]>([
    { id: "user-1", name: "John Doe", email: "entrepreneur@ideaforge.com", role: "homeowner", phone: "+1 (512) 555-0100", created_at: "2026-02-01" },
    { id: "tech-1", name: "Alex Smith", email: "consultant1@ideaforge.com", role: "technician", phone: "+1 (512) 555-0192", created_at: "2026-01-10" },
    { id: "tech-2", name: "Jordan Brooks", email: "consultant2@ideaforge.com", role: "technician", phone: "+1 (512) 555-0143", created_at: "2026-03-22" },
    { id: "tech-3", name: "Elena Rostova", email: "consultant3@ideaforge.com", role: "technician", phone: "+1 (512) 555-0177", created_at: "2025-05-18" },
    { id: "user-admin", name: "Sarah Jenkins", email: "admin@ideaforge.com", role: "admin", phone: "+1 (512) 555-0901", created_at: "2026-01-01" }
  ]);
    ...
    <DashboardLayout>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 font-medium">
            Review platform analytics, manage user roles, edit blueprint prices, and assign consultant audits.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div className="bg-slate-900/40 border border-slate-900 rounded-3xl p-5 flex flex-col justify-between">
          ...
          <span className="text-[9px] text-slate-500 font-semibold block mt-1">3 dispatch-ready advisors</span>
        </div>
          ...
          <div className="h-60 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={adminReports} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <YAxis stroke="#64748b" fontSize={10} />
                <Tooltip contentStyle={{ backgroundColor: "#0f172a", borderColor: "#1e293b", borderRadius: "12px" }} />
                <Bar dataKey="appointments" fill="#6366f1" radius={[4, 4, 0, 0]} name="Scheduled Audits" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
                ...
                {usersDb.map((u) => (
                  <tr key={u.id} className="hover:bg-slate-900/20 transition-colors">
                    ...
                    <td className="py-3.5 px-4 capitalize">
                      ...
                      >
                        <option value="homeowner">Entrepreneur</option>
                        <option value="technician">Consultant</option>
              ...
              <div key={pkg.id} className="p-5 bg-slate-950 border border-slate-850 rounded-2xl space-y-4">
                ...
                <div className="space-y-1.5">
                  <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">
                    Blueprint Catalog stock
                  </span>
                  <div className="flex justify-between items-center text-xs font-semibold text-slate-400">
                    <span>Active Gateways stock:</span>
